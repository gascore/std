...
func (r *Request) Upload() *Upload {
	return &Upload{v:r.v.Get("upload")}
}
...
func (r *Request) OverrideMimeType(mimetype string) {
	r.v.Call("overrideMimeType", mimetype)
}
...
func (r *Request) SetRequestHeader(header, value string) {
	r.v.Call("setRequestHeader", header, value)
}
...
func Send(method, url string, data []byte) (string, error) {
	...
	return sjs.Global().Get("Uint8Array").New(xhr.Response).String(), nil
}